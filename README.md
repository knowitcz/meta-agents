...
This repository contains the meta layer for designing AI customizations: agents, skills, prompts, flows, and instructions.

The core idea is simple: keep every artifact small, single-purpose, and easy for LLMs to load without wasting context.

## Entry Points

- [Meta prompt](.github/prompts/meta.prompt.md) - the starting point for asking about agents, skills, prompts, flows, or instructions.
...
- [Meta agents](.github/agents/) - specialized designers for agents, skills, instructions, prompts, and flows.
...
- Put complex procedural workflows (multi-step, branching, delegating) in flows.
